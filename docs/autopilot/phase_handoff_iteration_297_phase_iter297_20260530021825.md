...
1. `.codemaster_orchestration/opencode/dispatch/opencode_session_response_phase_iter297_20260530021722.json`
2. `.codemaster_orchestration/artifacts/opencode_session_stderr_phase_iter297_20260530021722.log`
...
- `owner_judgment = 负责人判断当前可继续编码推进。 当前主目标: `contract_version = relay_contract_v1``
...
- `previous_trace_id = phase_iter297_20260530021722`
- `previous_response_status = interrupted_after_meaningful_activity`
- `previous_returncode = `
- `previous_response_path = .codemaster_orchestration/opencode/dispatch/opencode_session_response_phase_iter297_20260530021722.json`
- `previous_stderr_path = .codemaster_orchestration/artifacts/opencode_session_stderr_phase_iter297_20260530021722.log`
