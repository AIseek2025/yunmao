...
1. `.codemaster_orchestration/opencode/dispatch/opencode_session_response_phase_iter297_20260529124320.json`
2. `.codemaster_orchestration/artifacts/opencode_session_stderr_phase_iter297_20260529124320.log`
...
- `previous_trace_id = phase_iter297_20260529124320`
- `previous_response_status = interrupted_after_meaningful_activity`
- `previous_returncode = `
- `previous_response_path = .codemaster_orchestration/opencode/dispatch/opencode_session_response_phase_iter297_20260529124320.json`
- `previous_stderr_path = .codemaster_orchestration/artifacts/opencode_session_stderr_phase_iter297_20260529124320.log`
