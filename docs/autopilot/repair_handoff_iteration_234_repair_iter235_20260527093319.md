...
1. `reports/work_report_iteration_234.md`
2. `reports/audit_report_iteration_234.md`
...
## Auto Diagnosis
- `detected_reason = repair_empty_output_without_new_work_report`
- `previous_trace_id = repair_iter235_20260527093130`
- `previous_response_status = empty_output`
- `previous_returncode = `
- `previous_response_path = .codemaster_orchestration/opencode/dispatch/opencode_session_response_repair_iter235_20260527093130.json`
- `previous_stderr_path = .codemaster_orchestration/artifacts/opencode_session_stderr_repair_iter235_20260527093130.log`
- `diagnosis_summary = 会话正常退出，但没有生成可解析正文，也没有形成显式交付输出。`
